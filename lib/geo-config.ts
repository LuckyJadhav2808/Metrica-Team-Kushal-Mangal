...
export const INDIAN_CITIES: Record<CityId, CityConfig> = {
  ...
  PUNE: {
    id: "PUNE",
    name: "Pune District",
    label: "📍 Pune District (4 Mandi Hubs)",
    state: "Maharashtra",
    ...
    hubs: [
      ...
      {
        id: "HADAPSAR",
        name: "Hadapsar Grain & Agro Produce Mandi",
        shortName: "Hadapsar",
        cityId: "PUNE",
        ...
        lng: 73.9259,
        pincode: "411028",
        description: "Eastern transit trade hub, grain storage, agricultural weighbridges",
        radiusMeters: 1600,
      },
      {
        id: "PIMPRI_MIDC",
...
export function getCoordinatesForInstrument(inst: Instrument, index: number): [number, number] {
  ...
  if (cityId === "MUMBAI") {
    ...
    if (address.includes("gultekdi") || pin === "411037") {
